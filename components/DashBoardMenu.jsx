...
function DashboardMenu() {
    ...
    return (
        <div id="menu" className="bg-white col-span-3 rounded-lg p-6">
            ...
            <Link href="#" className="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-5 items-center md:space-x-2 hover:bg-orange-100 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
                <div>
            ...
            <div id="menu" className="flex flex-col space-y-2 my-5">
                <Link href="/" className="hover:bg-orange-100 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                ...
                <Link href="/tareas" className="hover:bg-orange-100 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
